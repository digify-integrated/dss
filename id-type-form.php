<?php
    ...
    if($check_user_account_status){
        $page_details = $api->get_page_details(48);
        $module_id = $page_details[0]['MODULE_ID'];
        $page_title = $page_details[0]['PAGE_NAME'];
    
        $page_access_right = $api->check_role_access_rights($username, 48, 'page');
        ...
        if($module_access_right == 0 || $page_access_right == 0){
            ...
            if(isset($_GET['id']) && !empty($_GET['id'])){
                $id = $_GET['id'];
                $id_type_id = $api->decrypt_data($id);
            ...
            $update_id_type = $api->check_role_access_rights($username, '127', 'action');
...
<html lang="en">
    ...
    <body data-topbar="dark" data-layout="horizontal">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">ID Type Form</h4>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="apps.php">Apps</a></li>
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Employee</a></li>
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Configurations</a></li>
                                            <li class="breadcrumb-item"><a href="id-types.php">ID Types</a></li>
                                            <li class="breadcrumb-item active"><?php echo $page_title; ?></li>
                                            <?php
                                                if(!empty($id_type_id)){
                                                    echo '<li class="breadcrumb-item" id="id-type-id"><a href="javascript: void(0);">'. $id_type_id .'</a></li>';
                                                }
                                            ?>
                                        </ol>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <form id="id-type-form" method="post" action="#">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="d-flex align-items-start">
                                                        <div class="flex-grow-1 align-self-center">
                                                            <h4 class="card-title">ID Type Form</h4>
                                                        </div>
                                                        <div class="flex-grow-1 align-self-center">
                                                            <?php
                                                                if(!empty($id_type_id)){
                                                                    $dropdown_action = '<div class="btn-group">
                                                                        ...
                                                                        if($add_id_type > 0){
                                                                            $dropdown_action .= '<a class="dropdown-item" href="id-type-form.php">Add ID Type</a>';
                                                                        }
        
                                                                        if($delete_id_type > 0){
                                                                            $dropdown_action .= '<button class="dropdown-item" type="button" data-id-type-id="'. $id_type_id .'" id="delete-id-type">Delete ID Type</button>';
                                                                        }
                                                        ...
                                                        <div class="d-flex gap-2 flex-wrap">
                                                            <?php
                                                                if(empty($id_type_id) && $add_id_type > 0){
                                                                ...
                                                                else if(!empty($id_type_id) && $update_id_type > 0){
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-md-12">
                                                    <div class="row mb-4">
                                                        <input type="hidden" id="id_type_id" name="id_type_id" value="<?php echo $id_type_id; ?>">
                                                        <?php
                                                            if(empty($id_type_id) && $add_id_type > 0){
                                                                echo '<label for="id_type" class="col-md-2 col-form-label">ID Type <span class="text-danger">*</span></label>
                                                                <div class="col-md-10">
                                                                    <input type="text" class="form-control form-maxlength" autocomplete="off" id="id_type" name="id_type" maxlength="100" '. $disabled .'>
                                                                </div>';
                                                            }
                                                            else if(!empty($id_type_id) && $update_id_type > 0){
                                                                echo '<label for="id_type" class="col-md-2 col-form-label">ID Type <span class="text-danger">*</span></label>
                                                                <div class="col-md-10">
                                                                    ...
                                                                    <label class="col-form-label form-details" id="id_type_label"></label>
                                                                    <input type="text" class="form-control form-maxlength d-none form-edit" autocomplete="off" id="id_type" name="id_type" maxlength="100" '. $disabled .'>
                                                                </div>';
                                                            }
                                                        ?>
                                                    </div>
        ...
        <script src="assets/js/pages/id-type-form.js?v=<?php echo rand(); ?>"></script>
    </body>
</html>