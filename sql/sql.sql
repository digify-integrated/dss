...
CREATE TABLE technical_menu(
	...
	MENU_ID VARCHAR(200) UNIQUE,
	MENU_TITLE VARCHAR(100) NOT NULL,
	PARENT_MENU_ID VARCHAR(200),
	VIEW_ID VARCHAR(200),
	SEQUENCE INT
);
...
CREATE INDEX technical_menu_index ON technical_menu(EXTERNAL_ID);

CREATE TABLE technical_views(
	EXTERNAL_ID VARCHAR(200) PRIMARY KEY,
	VIEW_ID VARCHAR(200) UNIQUE,
...
CREATE INDEX technical_views_index ON technical_views(EXTERNAL_ID);
