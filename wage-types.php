<?php
    ...
    if($check_user_account_status){
        ...
        if($module_access_right == 0 || $page_access_right == 0){
            ...
            $add_wage_types = $api->check_role_access_rights($username, '114', 'action');
            $delete_wage_types = $api->check_role_access_rights($username, '116', 'action');
