                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="d-flex align-items-center">
                                                        <h4 class="card-title flex-grow-1">State Form</h4>
                                                        <div class="flex-shrink-0">
                                                            ...
                                                            <?php
                                                                if(!empty($state_id)){
                                                                    ...
                                                                    if($add_state > 0){
                                                                        $dropdown_action .= '<li><a class="dropdown-item" href="state-form.php">Add State</a></li>';
                                                                    }
    
                                                                    if($delete_state > 0){
                                                                        $dropdown_action .= '<li><button class="dropdown-item" type="button" data-state-id="'. $state_id .'" id="delete-state">Delete State</button></li>';
                                                                    }
