<?php
    ...
    $add_employee_types = $api->check_role_access_rights($username, '111', 'action');
    $delete_employee_types = $api->check_role_access_rights($username, '113', 'action');
