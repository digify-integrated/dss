<?php
    ...
    $page_details = $api->get_page_details(33);
    $module_id = $page_details[0]['MODULE_ID'];
    $page_title = $page_details[0]['PAGE_NAME'];
    
    $page_access_right = $api->check_role_access_rights($username, 33, 'page');
...
<html lang="en">
    ...
    <body data-topbar="dark" data-layout="horizontal">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Job Positions</h4>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                                    ...
                                                    <div class="d-flex gap-2 flex-wrap">
                                                        <?php
                                                            if($add_job_position > 0){
                                                                echo '<a href="job-position-form.php" class="btn btn-primary">
                                                        ...
                                                        <div class="offcanvas-body">
                                                            <div class="mb-3">
                                                                ...
                                                                <select class="form-control filter-select2" id="filter_status">
                                                                    ...
                                                                    <option value="1">Recruitment In Progress</option>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-12">
                                                <table id="job-positions-datatable" class="table table-bordered align-middle mb-0 table-hover table-striped dt-responsive nowrap w-100">
                                                    <thead>
                                                        <tr>
                                                            <th class="all">
                                                            ...
                                                            <th class="all">Job Position ID</th>
                                                            <th class="all">Job Position</th>
                                                            <th class="all">Department</th>
                                                            <th class="all">Current Number of Employees</th>
                                                            <th class="all">Expected New Employees</th>
                                                            <th class="all">Total Forecasted Employees</th>
        ...
        <script src="assets/js/pages/job-positions.js?v=<?php echo rand(); ?>"></script>
    </body>
</html>