<?php
    ...
    $page_details = $api->get_page_details(27);
    $module_id = $page_details[0]['MODULE_ID'];
    $page_title = $page_details[0]['PAGE_NAME'];
    
    $page_access_right = $api->check_role_access_rights($username, 27, 'page');
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Zoom API</h4>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-12">
                                                <div class="d-flex align-items-start">
                                                    <div class="flex-grow-1 align-self-center">
                                                        <h4 class="card-title">Zoom API List</h4>
                                                    </div>
                                                    <div class="flex-grow-1 align-self-center">
                                                        <?php
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-12">
                                                <table id="zoom-api-datatable" class="table table-bordered align-middle mb-0 table-hover table-striped dt-responsive nowrap w-100">
                                                    <thead>
                                                        <tr>
                                                            <th class="all">
                                                            ...
                                                            <th class="all">Zoom API ID</th>
                                                            <th class="all">Zoom API</th>
