<?php
    ...
    if($check_user_account_status){
        ...
        if($module_access_right == 0 || $page_access_right == 0){
            ...
            $delete_country = $api->check_role_access_rights($username, '62', 'action');
                                            ...
                                            <div class="col-md-12">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1 align-self-center">
                                                        <?php
                                                            if($delete_country > 0){
                                                                ...
                                                                if($delete_country > 0){
                                                                    $dropdown_action .= '<button class="dropdown-item d-none multiple" type="button" id="delete-country">Delete Country</button>';
                                                                }
                                                    ...
                                                    <div class="d-flex gap-2 flex-wrap">
                                                        <?php
                                                            if($add_country > 0){
                                                                echo '<a href="country-form.php" class="btn btn-primary w-sm">Create</a>';
                                                            }
                                                        ?>
                                                    </div>
                                                </div>
