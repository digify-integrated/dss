...
INSERT INTO `global_user_account` VALUES ('ADMIN','68aff5412f35ed76','Administrator','Active','2022-12-30',0,'2022-10-27 13:02:32','2022-10-27 13:02:36','TL-1',NULL);
...
INSERT INTO `technical_menu` VALUES ('1','1','0','Settings','',NULL,0,NULL,'TL-7',1),('2','1','0','Modules','',NULL,1,'page.php?module=09&menu=0a','TL-8',1),('3','1','1','Models','',NULL,1,'page.php?module=09&menu=0b','TL-9',2),('4','1','0','Menu Items','',NULL,1,'page.php?module=09&menu=0c','TL-10',3),('5','1','1','Views','',NULL,1,'page.php?module=09&menu=0d','TL-11',4),('6','1','0','Plugins','',NULL,1,'page.php?module=09&menu=0e','TL-12',5);
...
--
-- Table structure for table `technical_view_javascript`
--

DROP TABLE IF EXISTS `technical_view_javascript`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `technical_view_javascript`
--

LOCK TABLES `technical_view_javascript` WRITE;
/*!40000 ALTER TABLE `technical_view_javascript` DISABLE KEYS */;
/*!40000 ALTER TABLE `technical_view_javascript` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-10-27 18:34:14
