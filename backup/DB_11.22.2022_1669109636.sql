...
INSERT INTO `global_system_code` VALUES ('SYSTYPE','SYSTYPE','System Code','TL-4'),('SYSTYPE','MODULECAT','Module Category','TL-5'),('MODULECAT','TECHNICAL','Technical','TL-6'),('SYSTYPE','ACTTYPE','Action Type','TL-14'),('ACTTYPE','ADD','Add','TL-14'),('ACTTYPE','UPDATE','Update','TL-15'),('ACTTYPE','DELETE','Delete','TL-16'),('ACTTYPE','ACTIVATE','Activate','TL-17'),('ACTTYPE','DEACTIVATE','Deactivate','TL-18'),('ACTTYPE','LOCK','Lock','TL-19'),('ACTTYPE','UNLOCK','Unlock','TL-20'),('ACTTYPE','APPROVE','Approve','TL-21'),('ACTTYPE','REJECT','Reject','TL-22'),('ACTTYPE','CANCEL','Cancel','TL-23');
...
INSERT INTO `technical_action` VALUES ('1','Add Menu Item','ADD','TL-25',NULL,NULL),('2','Update Menu Item','UPDATE','TL-25',NULL,NULL),('3','Delete Menu Item','DELETE','TL-26',NULL,NULL);
...
INSERT INTO `technical_plugin` VALUES ('1','Max Length',NULL,'<script src=\"assets/libs/bootstrap-maxlength/bootstrap-maxlength.min.js\"></script>','TL-13',NULL),('2','Sweet Alert','<link rel=\"stylesheet\" href=\"assets/libs/sweetalert2/sweetalert2.min.css\">','<script src=\"assets/libs/sweetalert2/sweetalert2.min.js\"></script>','TL-14',NULL),('3','Data Table (Basic)','<link href=\"assets/libs/datatables.net-bs4/css/dataTables.bootstrap4.min.css\" rel=\"stylesheet\" type=\"text/css\" />','<script src=\"assets/libs/datatables.net/js/jquery.dataTables.min.js\"></script><script src=\"assets/libs/datatables.net-bs4/js/dataTables.bootstrap4.min.js\"></script><script src=\"assets/libs/datatables.net-responsive/js/dataTables.responsive.min.js\"></script><script src=\"assets/libs/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js\"></script>','TL-15',NULL),('4','JQuery Validation',NULL,'<script src=\"assets/libs/jquery-validation/js/jquery.validate.min.js\"></script>','TL-16',NULL),('5','Select2','<link href=\"assets/libs/select2/css/select2.min.css\" rel=\"stylesheet\" type=\"text/css\" />','<script src=\"assets/libs/select2/js/select2.min.js\"></script>','TL-17',NULL);
...
INSERT INTO `technical_view` VALUES ('1','Menu Item List','1',1,1,'<table id=\"menu-item-datatable\" class=\"table table-bordered align-middle mb-0 table-hover table-striped dt-responsive nowrap w-100\">\n                                                    <thead>\n                                                        <tr>\n                                                            <th class=\"all\">\n                                                                <div class=\"form-check\">\n                                                                    <input class=\"form-check-input\" id=\"datatable-checkbox\" type=\"checkbox\">\n                                                                </div>\n                                                            </th>\n                                                            <th class=\"all\">Menu</th>\n                                                            <th class=\"all\">Parent Menu</th>\n                                                            <th class=\"all\">Module</th>\n                                                            <th class=\"all\">Order Sequence</th>\n                                                            <th class=\"all\">Action</th>\n                                                        </tr>\n                                                    </thead>\n                                                    <tbody></tbody>\n                                                </table>','','<script src=\"assets/js/pages/menu-items.js?v={version}\"></script>','TL-28',NULL,1);
...
--
-- Table structure for table `technical_view_action`
--

DROP TABLE IF EXISTS `technical_view_action`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `technical_view_action`
--

LOCK TABLES `technical_view_action` WRITE;
/*!40000 ALTER TABLE `technical_view_action` DISABLE KEYS */;
INSERT INTO `technical_view_action` VALUES ('1','1'),('1','3');
/*!40000 ALTER TABLE `technical_view_action` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `technical_view_type`
--

DROP TABLE IF EXISTS `technical_view_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `technical_view_type` (
  `VIEW_TYPE_ID` varchar(100) NOT NULL,
  `VIEW_TYPE` varchar(200) NOT NULL,
  `TEMPLATE` longtext NOT NULL,
  `TRANSACTION_LOG_ID` varchar(100) NOT NULL,
  PRIMARY KEY (`VIEW_TYPE_ID`),
  KEY `technical_view_type_index` (`VIEW_TYPE_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `technical_view_type`
--

LOCK TABLES `technical_view_type` WRITE;
/*!40000 ALTER TABLE `technical_view_type` DISABLE KEYS */;
INSERT INTO `technical_view_type` VALUES ('1','Data Table','<div class=\"row\">\n                            <div class=\"col-md-12\">\n                                <div class=\"card\">\n                                    <div class=\"card-body\">\n                                        <div class=\"row\">\n											<div class=\"col-md-12\">\n                                                <div class=\"d-flex align-items-start\">\n                                                    <div class=\"flex-grow-1 align-self-center\">\n                                                        <h4 class=\"card-title\">{card_title}</h4>\n                                                    </div>\n                                                    <div class=\"d-flex gap-2\">\n                                                        {action}\n														{filter_button}\n                                                    </div>\n                                                </div>\n												{filter}\n                                            </div>\n										</div>\n                                        <div class=\"row mt-4\">\n                                            <div class=\"col-md-12\">\n                                                {content}\n                                            </div>\n                                        </div>       \n                                    </div>\n                                </div>\n                            </div>\n                        </div>','TL-27');
/*!40000 ALTER TABLE `technical_view_type` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_view_action_details` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_unicode_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_view_action_details`(IN `view_id` VARCHAR(100))
BEGIN
	SET @view_id = view_id;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_view_type_details` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_unicode_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_view_type_details`(IN view_type_id VARCHAR(100))
BEGIN
...
-- Dump completed on 2022-11-22 17:33:56
