...
INSERT INTO `employee_personal_information` VALUES ('6','Agulto, Lawrence, De Vera, II','Lawrence','De Vera','Agulto','II','test','DIVORCED','AFGHAN','MALE','2023-03-08','asdasd','AB+',28,20,'ATHEIST','UPD->ADMIN->2023-03-10 05:08:56');
...
INSERT INTO `global_user_account` VALUES ('ADMIN','QRyho%2BfZvLj%2FbBqneeHdDLJHCjSufF8U4P%2B1QUxqo%2FU%3D','Administrator','Active','2023-08-16',0,'2023-03-28 17:19:06','2023-03-29 08:50:30','TL-1','LCK->ADMIN->2023-02-16 03:00:33'),('LDAGULTO','epDqiHZKCYMYGdBujdCTypawAuctHHcMNfKaL6IuqPE=','Lawrence Agulto','Active','2023-08-14',0,'2023-03-21 14:31:06','2023-03-27 09:10:55','229','ACT->ADMIN->2023-02-18 08:09:10');
...
/*!50003 SET collation_connection  = utf8mb4_unicode_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_employee_image`(IN employee_id VARCHAR(100), IN employee_image VARCHAR(500))
BEGIN
...
/*!50003 SET collation_connection  = utf8mb4_unicode_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_employee_status`(IN employee_id VARCHAR(100), IN employee_status TINYINT(1), IN offboard_date DATE, IN departure_reason VARCHAR(50), IN details_reason VARCHAR(500), IN record_log VARCHAR(100))
BEGIN
...
-- Dump completed on 2023-03-29 17:35:15
