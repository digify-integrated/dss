...
INSERT INTO `global_user_account` VALUES ('ADMIN','QRyho%2BfZvLj%2FbBqneeHdDLJHCjSufF8U4P%2B1QUxqo%2FU%3D','Administrator','Active','2023-08-16',0,'2023-03-28 17:19:06','2023-03-28 17:19:11','TL-1','LCK->ADMIN->2023-02-16 03:00:33'),('LDAGULTO','epDqiHZKCYMYGdBujdCTypawAuctHHcMNfKaL6IuqPE=','Lawrence Agulto','Active','2023-08-14',0,'2023-03-21 14:31:06','2023-03-27 09:10:55','229','ACT->ADMIN->2023-02-18 08:09:10');
...
/*!50003 SET collation_connection  = utf8mb4_unicode_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_employee_digital_signature`(IN employee_id VARCHAR(100), IN employee_digital_signature VARCHAR(500))
BEGIN
...
-- Dump completed on 2023-03-28 17:33:21
