...
CREATE TABLE `employee_contact_information` (
  `EMPLOYEE_CONTACT_INFROMATION_ID` varchar(100) NOT NULL,
  `EMPLOYEE_ID` varchar(100) NOT NULL,
  ...
  `TRANSACTION_LOG_ID` varchar(100) DEFAULT NULL,
  `RECORD_LOG` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`EMPLOYEE_CONTACT_INFROMATION_ID`),
  KEY `employee_contact_information_index` (`EMPLOYEE_CONTACT_INFROMATION_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `global_user_account` VALUES ('ADMIN','QRyho%2BfZvLj%2FbBqneeHdDLJHCjSufF8U4P%2B1QUxqo%2FU%3D','Administrator','Active','2023-08-16',0,'2023-03-28 17:19:06','2023-03-30 09:15:31','TL-1','LCK->ADMIN->2023-02-16 03:00:33'),('LDAGULTO','epDqiHZKCYMYGdBujdCTypawAuctHHcMNfKaL6IuqPE=','Lawrence Agulto','Active','2023-08-14',0,'2023-03-21 14:31:06','2023-03-27 09:10:55','229','ACT->ADMIN->2023-02-18 08:09:10');
...
-- Dump completed on 2023-03-30 17:51:27
