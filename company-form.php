                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="d-flex align-items-center">
                                                        <h4 class="card-title flex-grow-1">Company Form</h4>
                                                        <div class="flex-shrink-0">
                                                            ...
                                                            <?php
                                                                if(!empty($company_id)){
                                                                    ...
                                                                    if($add_company > 0){
                                                                        $dropdown_action .= '<li><a class="dropdown-item" href="company-form.php">Add Company</a></li>';
                                                                    }
    
                                                                    if($delete_company > 0){
                                                                        $dropdown_action .= '<li><button class="dropdown-item" type="button" data-company-id="'. $company_id .'" id="delete-company">Delete Company</button></li>';
                                                                    }
