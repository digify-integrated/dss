<?php
    ...
    if($check_user_account_status){
        $page_details = $api->get_page_details(17);
        $module_id = $page_details[0]['MODULE_ID'];
        $page_title = $page_details[0]['PAGE_NAME'];
    
        $page_access_right = $api->check_role_access_rights($username, 17, 'page');
...
<html lang="en">
    ...
    <body data-topbar="dark" data-layout="horizontal">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Interface Settings</h4>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-12">
                                                <div class="d-flex align-items-start">
                                                    <div class="flex-grow-1 align-self-center">
                                                        <h4 class="card-title">Interface Setting List</h4>
                                                    </div>
                                                    <div class="flex-grow-1 align-self-center">
                                                        <?php
                                                            if($delete_interface_setting > 0){
                                                                ...
                                                                if($delete_interface_setting > 0){
                                                                    $dropdown_action .= '<button class="dropdown-item d-none multiple" type="button" id="delete-interface-setting">Delete Interface Setting</button>';
                                                                }
                                                    ...
                                                    <div class="d-flex gap-2 flex-wrap">
                                                        <?php
                                                            if($add_interface_setting > 0){
                                                                echo '<a href="interface-setting-form.php" class="btn btn-primary w-sm">Create</a>';
                                                            }
                                                        ?>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-12">
                                                <table id="interface-settings-datatable" class="table table-bordered align-middle mb-0 table-hover table-striped dt-responsive nowrap w-100">
                                                    <thead>
                                                        <tr>
                                                            <th class="all">
                                                            ...
                                                            <th class="all">Interface Setting ID</th>
                                                            <th class="all">Interface Setting</th>
        ...
        <script src="assets/js/pages/interface-settings.js?v=<?php echo rand(); ?>"></script>
    </body>
</html>