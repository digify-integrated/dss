                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form id="system-code-form" method="post" action="#">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="d-flex align-items-start">
                                                        ...
                                                        <div class="d-flex gap-2 flex-wrap">
                                                            <?php
                                                                if(empty($system_code_id) && $add_system_code > 0){
                                                                ...
                                                                else if(!empty($system_code_id) && $update_system_code > 0){
                                            ...
                                            <div class="row mt-4">
                                                <input type="hidden" id="system_code_id" name="system_code_id" value="<?php echo $system_code_id; ?>">
                                                <?php
                                                    if(empty($system_code_id) && $add_system_code > 0){
                                                        echo '<div class="col-md-6">
                                                                <div class="row mb-4">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <select class="form-control select2" id="system_type" name="system_type" '. $disabled .'>
                                                                            <option value="">--</option>
                                                                            '. $api->generate_system_code_options('SYSTYPE') .'
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <div class="row mb-4">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <input type="text" class="form-control form-maxlength" autocomplete="off" id="system_description" name="system_description" maxlength="100" '. $disabled .'>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="row mb-4">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <input type="text" class="form-control form-maxlength" autocomplete="off" id="system_code" name="system_code" maxlength="20" '. $disabled .'>
                                                                    </div>
                                                                </div>
                                                            </div>';
                                                    }
                                                        ...
                                                        echo '<div class="col-md-6">
                                                                <div class="row mb-4">
                                                                    ...
                                                                    <label for="system_code" class="col-md-3 col-form-label">System Type <span class="text-danger">*</span></label>
                                                                    <div class="col-md-9">
                                                                        <label class="col-form-label form-details" id="system_type_label"></label>
                                                                ...
                                                                <div class="row mb-4">
                                                                    <label for="system_description" class="col-md-3 col-form-label">System Code Description <span class="text-danger">*</span></label>
                                                                    <div class="col-md-9">
                                                                        <label class="col-form-label form-details" id="system_description_label"></label>
                                                                        <input type="text" class="form-control form-maxlength d-none form-edit" autocomplete="off" id="system_description" name="system_description" maxlength="100" '. $disabled .'>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="row mb-4">
                                                                    <label for="system_code" class="col-md-3 col-form-label">System Code <span class="text-danger">*</span></label>
                                                                    <div class="col-md-9">
                                                                        <label class="col-form-label form-details" id="system_code_label"></label>
                                                                        <input type="text" class="form-control form-maxlength d-none form-edit" autocomplete="off" id="system_code" name="system_code" maxlength="20" '. $disabled .'>
                                                                    </div>
                                                                </div>
                                                            </div>';
                                                    }
