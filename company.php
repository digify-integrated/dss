<?php
    ...
    if($check_user_account_status){
        $page_details = $api->get_page_details(15);
        $module_id = $page_details[0]['MODULE_ID'];
        $page_title = $page_details[0]['PAGE_NAME'];
    
        $page_access_right = $api->check_role_access_rights($username, 15, 'page');
                                            ...
                                            <div class="col-md-12">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1 align-self-center">
                                                        <?php
                                                            if($delete_company > 0){
                                                                ...
                                                                if($delete_company > 0){
                                                                    $dropdown_action .= '<button class="dropdown-item d-none multiple" type="button" id="delete-company">Delete Company</button>';
                                                                }
                                                    ...
                                                    <div class="d-flex gap-2 flex-wrap">
                                                        <?php
                                                            if($add_company > 0){
                                                                echo '<a href="company-form.php" class="btn btn-primary w-sm">Create</a>';
                                                            }
                                                        ?>
                                                    </div>
                                                </div>
