                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if(response[0]['RESPONSE'] === 'Inserted'){
                            ...
                            show_toastr('Update Successful', 'The working schedule type has been updated successfully.', 'success');
                        }
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    ...
                    success: function (response) {
                        if(response === 'Deleted'){
                            show_toastr('Delete Working Schedule Type Successful', 'The working schedule type has been deleted successfully.', 'success');
                        }
                        else if(response === 'Inactive User' || response === 'Not Found'){
                            window.location = '404.php';
                        }
                        else{
                            show_toastr('Delete Working Schedule Type Error', response, 'error');
                        }
                    }
                });
                return false;
