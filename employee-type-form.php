                                                ...
                                                <div class="col-md-12">
                                                    <div class="d-flex align-items-start">
                                                        ...
                                                        <div class="d-flex gap-2 flex-wrap">
                                                            <?php
                                                                if(($add_employee_type > 0 || ($update_employee_type > 0 && !empty($employee_type_id)))){
                                                                    echo '<button type="submit" for="employee-type-form" id="submit-data" class="btn btn-primary">
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-md-12">
                                                    <div class="row mb-4">
                                                        ...
                                                        <label for="employee_type" class="col-md-2 col-form-label">Employee Type <span class="text-danger">*</span></label>
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control form-maxlength" autocomplete="off" id="employee_type" name="employee_type" maxlength="100" <?php echo $disabled; ?>>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
